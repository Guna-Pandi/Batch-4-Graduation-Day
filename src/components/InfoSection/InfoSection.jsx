...
const InfoSection = ( { header, subtitle, children, lineColorCode, textColorCode } ) => {
   return (
      <section className="flex flex-col items-center tracking-wide text-center z-50">
         ...
         <hr className={ `w-32 mx-auto my-2 border-2 rounded-md ${ lineColorCode }` } />
         {
            subtitle &&
            <p className={ ` font-semibold mb-3 text-2xl ${ textColorCode? textColorCode : 'text-gray-light' } ` }> { subtitle } </p>
         }
